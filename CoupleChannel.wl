...
GetContactAmp2::usage = "Get amplitude and keep the spinor";
AmpIsospinSpace::usage="Amplitude in isospin space";
...
Get[FileNameJoin[{DirectoryName[$InputFileName],"Amplitude.wl"}]]
